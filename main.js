...
cakeBuddiesImg.addEventListener('click', function () {
    if (cakeBuddiesState == "off") {
        ...
        switchSound.play();
        setTimeout(function () { cakeBuddiesImg.src = "cake-buddies-lit.png"; }, 16000);
        setTimeout(function () { nextPageButton.style.display = "inline"; }, 32000);
        setTimeout(function () {
        ...
        let birthdaySong = new Audio('happy-birthday-struggle.mp3');
        birthdaySong.play();
    }
})
